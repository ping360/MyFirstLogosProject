...
public class ItemServiceImpl implements ItemService{
	...
	public void save(ItemForm itemForm){
		...
		for (FeatureDigitalForm featureDigital : itemForm.getFeatureDigitals()) {
			FeatureDigital fd = featureDigitalRepository.findByNofdValue(featureDigital.getNameOfFeatureDigital().getId(), new BigDecimal(featureDigital.getValue().replace(',', '.')));
			if(fd==null){
