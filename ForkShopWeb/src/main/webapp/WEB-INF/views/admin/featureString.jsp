...
<div class="row">
	<div class="col-md-3 col-xs-12">
		<form:form modelAttribute="filter" action="/admin/fs" method="get" class="form-inline">
	...
	<div class="col-md-7 col-xs-12">
		<div class="row">
			<div class="col-md-12 col-xs-12">
				<form:form class="form-horizontal" action="/admin/fs" method="POST" modelAttribute="fs">
<%-- 					<custom:hiddenInputs excludeParams="name, nameOSpecificationString"/> --%>
<!-- 					<div class="form-group"> -->
...
<!--   					</div> -->
		...
		<div class="row">
			...
			<c:forEach items="${page.content}" var="specString">
				<div class="row">
					<div class="col-md-4 col-xs-4">${specString.name}</div>
					<div class="col-md-4 col-xs-4"><a class="btn btn-warning" href="/admin/fs/update/${specString.id}<custom:allParams/>">update</a></div>
					<div class="col-md-4 col-xs-4"><a class="btn btn-danger" href="/admin/fs/delete/${specString.id}<custom:allParams/>">delete</a></div>
				</div>
			</c:forEach>
	</div>
