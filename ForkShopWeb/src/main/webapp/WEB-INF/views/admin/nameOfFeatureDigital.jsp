		...
		<div class="container-fluid">
			...
			<div class="collapse navbar-collapse" id="myNavbar">
				<ul class="nav navbar-nav">
					...
					<li class="active"><a href="/admin/nofd">Name of feature digital</a></li>
...
<div class="row">
	<div class="col-md-3 col-xs-12">
		<form:form modelAttribute="filter" action="/admin/nofd" method="get" class="form-inline">
	...
	<div class="col-md-7 col-xs-12">
		...
		<div class="row">
			<div class="col-md-4 col-xs-4"><h3>Name of feature digital</h3></div>
